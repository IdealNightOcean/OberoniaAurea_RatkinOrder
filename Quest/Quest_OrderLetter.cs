...
public class QuestNode_OrderLetter : QuestNode
{
    ...
    protected override void RunInt()
    {
        ...
        questPart_OrderLetter.InSignal = QuestGenUtility.HardcodedSignalWithQuestID(inSignal.GetValue(slate)) ?? slate.Get<string>(OARO_KeyLibrary_SlateStoreAs.inSignal);
        ...
        questPart_OrderLetter.RelatedOrder = relatedOrder.GetValue(slate) ?? slate.Get<RatkinOrder>(OARO_KeyLibrary_SlateStoreAs.ratkinOrder);
        questPart_OrderLetter.RelatedBranch = relatedBranch.GetValue(slate) ?? slate.Get<Branch>(OARO_KeyLibrary_SlateStoreAs.branch);
