...
{
    public static bool TryGetStatTransformer(Branch branch, BranchStatDef statDef, out BranchStatTransformer transformer)
    {
        transformer = default;
    ...
    public static float GetStatValue(Branch branch, BranchStatDef statDef, float? baseValueOverride = null, bool immediateUpdate = false)
    {
        return statDef.Worker.GetValue(branch, baseValueOverride, immediateUpdate);
    }

    public static float GetNewStatValue(Branch branch, BranchStatDef statDef, float? baseValueOverride = null)
    {
        float result;
    ...
    public static float GetNewStatValueFormTrans(Branch branch, BranchStatDef statDef, BranchStatTransformer transformer, float? baseValueOverride = null)
    {
    ...
    public static StringBuilder GetStatExplanation(Branch branch, BranchStatDef statDef, float? baseValueOverride = null)
    {
