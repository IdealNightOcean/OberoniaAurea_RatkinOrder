...
{
    public static bool TryAssistSupport(Squad squad, Map map, int member, int commander)
    {
    ...
    private static (List<Pawn> members, List<Pawn> commanders) GeneratePawns(Squad squad, Map map, int memberCount, int commanderCount)
    {
    ...
    private static void CombatPawnsArrival(Squad squad, Map map, bool friendly, IEnumerable<Pawn> members, IEnumerable<Pawn> commanders)
    {
        Faction faction = squad.RatkinOrder.Faction;
    ...
    private static void MakeAttackJob(Squad squad, Map map, IntVec3 spawnCenter, IEnumerable<Pawn> members, IEnumerable<Pawn> commanders)
    {
    ...
    private static void MakeSupportJob(Squad squad, Map map, IntVec3 spawnCenter, IEnumerable<Pawn> members, IEnumerable<Pawn> commanders)
    {
        IntVec3 originCell = spawnCenter.IsValid ? spawnCenter : members.FirstOrFallback().PositionHeld;
        RCellFinder.TryFindRandomSpotJustOutsideColony(originCell, map, out IntVec3 result);
        Faction faction = squad.RatkinOrder.Faction;
    ...
    private static string GetLetterText(Squad squad)
    {
        Faction faction = squad.RatkinOrder.Faction;
