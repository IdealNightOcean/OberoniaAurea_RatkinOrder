...
public class StatPart_MeditationBase : StatPart
{
    public override void TransformValue(StatRequest req, ref float val)
    {
        ...
        val += ResidentKnightsManager.InstructorKnightsCount * 5f;
    }
    ...
    public override string ExplanationPart(StatRequest req)
    {
        ...
        int academicFurnituresCount = OrderHallHandler.AcademicFurnituresCount;
        if (academicFurnituresCount > 0)
        {
            stepChange = Mathf.Min(OrderHallHandler.AcademicFurnituresCount * 2, 30);
        ...
        int instructorKnightsCount = ResidentKnightsManager.InstructorKnightsCount;
